...
import LinkAdmin from '@/Components/LinkAdmin.vue';
    ...
    <div>
        ...
        <div class="min-h-screen bg-white">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <div v-for="(link, index) in navLinks" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    <template v-if="$page.props.jetstream.managesProfilePhotos" #trigger>
                                        <div class="flex">
                                            <button type="button"
            ...
            <div  class="flex">
                ...
                <div v-if="$page.props.user.is_admin == 1" class="flex flex-col h-screen p-3 bg-white shadow w-60">
                    <div class="space-y-3">
                        <div class="flex items-center">
                            ...
                            <ul class="pt-2 pb-4 space-y-1 text-sm">
                                <li class="rounded-sm">
                                    <a href="#" class="flex items-center p-2 space-x-3 rounded-md">
                                        ...
                                        <span><LinkAdmin :href="route('dashboard')" :active="route().current('dashboard')">
                                            Home
                                        </LinkAdmin></span>
                                    </a>
                                </li>
                                <li class="rounded-sm">
                                    <div class="flex items-center p-2 space-x-3 rounded-md">
                                        <PresentationChartBarIcon class="h-6 w-6 text-black-500" />
                                        <span>
                                            <LinkAdmin :href="route('reports')" :active="route().current('reports')">
                                                Reports
                                            </LinkAdmin>
                                        </span>
                                    </div>
                                ...
                                <li class="rounded-sm">
                                    <div class="flex items-center p-2 space-x-3 rounded-md">
                                        ...
                                        <DocumentTextIcon class="h-6 w-6 text-black-500" />
                                        <span>
                                            <LinkAdmin :href="route('manage.products')" :active="route().current('manage.products')">
                                                Products
                                            </LinkAdmin>
                                        </span>
                                    </div>
